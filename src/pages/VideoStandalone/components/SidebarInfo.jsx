...
const SidebarInfo = ({
    ...
    /* ======================================================
       ...
       Lý do: Data từ feed (videoData) hay bị thiếu ảnh/sđt.
    ...
    const handleOpenDetails = async () => {
        ...
        try {
            ...
            // Cập nhật data đầy đủ (có danh sách ảnh, sđt chuẩn)
    ...
    /* ======================================================
       LOGIC: POST & DELETE COMMENT (GIỮ NGUYÊN)
    ====================================================== */
    ...
    const handleInputChange = (e) => {
        ...
        if (val.length <= 150) setCommentText(val);
    };

    const handleKeyDown = (e) => {
        if (e.key === 'Enter' && !e.shiftKey) {
            e.preventDefault();
            handlePostCommentGeneric(commentText, replyingTo ? replyingTo.id : null);
        }
    };
