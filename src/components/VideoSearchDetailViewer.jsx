                    ...
                    <div className={styles.commentWrapper} style={{ display: 'flex', alignItems: 'flex-start', position: 'relative' }}>
                      ...
                      <div className="comment-main" style={{ display: 'flex', flexDirection: 'column', width: '100%' }}>
                        <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
                          ...
                          {reply.replyTo && (
                            <span className="reply-to" style={{ color: '#888', fontSize: 13, marginLeft: 4 }}>trả lời {reply.replyTo}
                          </span>                          )}
                          {reply.userId === currentUserId && (
                            <div className="menu-wrapper-child" style={{ position: 'absolute', right: '20px', left: '340px', top: '15px' }}>                              <button
